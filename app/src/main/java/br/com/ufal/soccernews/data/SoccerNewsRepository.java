package br.com.ufal.soccernews.data;

import androidx.room.Room;
import br.com.ufal.soccernews.App;
import br.com.ufal.soccernews.data.local.SoccerNewsDb;
...
public class SoccerNewsRepository {
    //region Constantes
    private static final String REMOTE_API_URL = "https://alexandretopeca.github.io/soccer-news-api/";
